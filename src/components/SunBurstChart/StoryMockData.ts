	...
	children: [
		{
			...
			children: [
				...
				{
					search_terms: "Intestinal Cancer",
					count: 1,
				},
				{
				...
				{
					search_terms: "Extrahepatic Bile Duct Adenocarcinoma",
					count: 1,
				},
				{
				...
				{
					search_terms: "Gastric Small Cell Neuroendocrine Carcinoma",
					count: 2,
				},
				{
				...
				{
					search_terms: "Liver and Intrahepatic Bile Duct Carcinoma",
					count: 12,
				},
				{
				...
				{
					search_terms: "Gastroesophageal Junction Adenocarcinoma",
					count: 17,
				},
				{
					search_terms: "Pancreatic Mixed Acinar-Neuroendocrine Carcinoma",
					count: 1,
				},
				{
				...
				{
					search_terms: "Colon Serrated Lesions and Polyps",
					count: 1,
				},
				{
				...
				{
					search_terms: "Pancreatic Undifferentiated Carcinoma",
					count: 1,
				},
				{
				...
				{
					search_terms: "Colon Tubulovillous Adenoma",
					count: 2,
				},
				{
				...
				{
					search_terms: "Small Intestinal Tubulovillous Adenoma",
					count: 1,
				},
				{
				...
				{
					search_terms: "Rectal Cribriform Comedo-Type Adenocarcinoma",
					count: 1,
				},
				{
				...
				{
					search_terms: "Gallbladder Undifferentiated Carcinoma",
					count: 2,
				},
				{
				...
				{
					search_terms: "Colon Tubular Adenoma",
					count: 1,
				},
				{
				...
				{
					search_terms: "Gastric Signet Ring Cell Adenocarcinoma",
					count: 5,
				},
				{
				...
				{
					search_terms: "Pancreatic Somatostatinoma",
					count: 1,
				},
				{
				...
				{
					search_terms: "Extrahepatic Bile Duct Adenosquamous Carcinoma",
					count: 1,
				},
				{
		...
		{
			search_terms: "Reproductive System ",
			children: [
				{
				...
				{
					search_terms: "Ovarian Serous Surface Papillary Adenocarcinoma",
					count: 4,
				},
				{
					search_terms: "Low Grade Ovarian Serous Adenocarcinoma",
					count: 1,
				},
				{
					search_terms: "Female Reproductive System Cancer",
					count: 4,
				},
				{
				...
				{
					search_terms: "Malignant Ovarian Endometrioid Tumor",
					count: 1,
				},
				{
				...
				{
					search_terms: "Endometrial Endometrioid Adenocarcinoma",
					count: 34,
				},
				{
					search_terms:
				...
				{
					search_terms: "Squamous Cell Carcinoma of the Penis",
					count: 2,
				},
				{
				...
				{
					search_terms: "Malignant Mixed Mesodermal (Mullerian) Tumor",
					count: 9,
				},
				{
					search_terms: "High Grade Ovarian Serous Adenocarcinoma",
					count: 80,
				},
				{
					search_terms: "Malignant Ovarian Granulosa Cell Tumor",
					count: 1,
				},
				{
				...
				{
					search_terms: "Ovarian Granulosa Cell Tumor",
					count: 1,
				},
				{
				...
				{
					search_terms: "Childhood Malignant Testicular Germ Cell Tumor",
					count: 1,
				},
				{
					search_terms: "Testicular Teratoma",
					count: 1,
				},
				{
				...
				{
					search_terms: "Ovarian Mixed Germ Cell Tumor",
					count: 1,
				},
			],
		},
		{
			search_terms: "Thoracic ",
			children: [
				{
				...
				{
					search_terms: "Lung Basaloid Squamous Cell  Carcinoma",
					count: 1,
				},
				{
		...
		{
			search_terms: "Hematopoietic and Lymphoid System ",
			children: [
				{
				...
				{
					search_terms: "Childhood Acute Myeloid Leukemia with Maturation",
					count: 1,
				},
				{
					search_terms: "Mature T-Cell and NK-Cell Non-Hodgkin Lymphoma",
					count: 1,
				},
				{
					search_terms: "Peripheral T-Cell Lymphoma, Not Otherwise Specified",
					count: 1,
				},
				{
					search_terms: "Early T Acute Lymphoblastic Leukemia",
					count: 6,
				},
				{
				...
				{
					search_terms: "Chronic Myelogenous Leukemia, BCR-ABL1 Positive",
					count: 18,
				},
				{
				...
				{
					search_terms: "Childhood B Acute Lymphoblastic Leukemia",
					count: 16,
				},
				{
				...
				{
					search_terms: "Adult B Acute Lymphoblastic Leukemia",
					count: 7,
				},
				{
					search_terms: "T-Cell Large Granular Lymphocyte Leukemia",
					count: 1,
				},
				{
				...
				{
					search_terms: "Acute Leukemia of Ambiguous Lineage",
					count: 1,
				},
				{
					search_terms: "Mycosis Fungoides and Sezary Syndrome",
					count: 2,
				},
				{
					search_terms: "EBV-Related Burkitt Lymphoma",
					count: 12,
				},
				{
					search_terms: "Natural Killer Cell Lymphoblastic Leukemia/Lymphoma",
					count: 5,
				},
				{
				...
				{
					search_terms: "Acute Promyelocytic Leukemia with PML-RARA",
					count: 1,
				},
				{
				...
				{
					search_terms: "Blastic Plasmacytoid Dendritic Cell Neoplasm",
					count: 1,
				},
				{
				...
				{
					search_terms: "Childhood Acute Megakaryoblastic Leukemia",
					count: 3,
				},
				{
				...
				{
					search_terms: "Primary Cutaneous T-Cell Non-Hodgkin Lymphoma",
					count: 5,
				},
				{
					search_terms:
				...
				{
					search_terms: "Primary Mediastinal (Thymic) Large B-Cell Lymphoma",
					count: 1,
				},
				{
				...
				{
					search_terms: "Childhood T Acute Lymphoblastic Leukemia",
					count: 24,
				},
			],
		},
		{
			...
			children: [
				...
				{
					search_terms: "Stage 0 Cutaneous Melanoma AJCC v6 and v7",
					count: 2,
				},
				{
		...
		},
		{
			...
			children: [
				...
				{
					search_terms: "Head and Neck Squamous Cell Carcinoma",
					count: 35,
				},
				{
				...
				{
					search_terms: "Salivary Gland Mucoepidermoid Carcinoma",
					count: 1,
				},
				{
				...
				{
					search_terms: "Thyroid Gland Squamous Cell Carcinoma",
					count: 2,
				},
				{
					search_terms: "Parotid Gland Mucoepidermoid Carcinoma",
					count: 1,
				},
				{
				...
				{
					search_terms: "Salivary Gland Squamous Cell Carcinoma",
					count: 1,
				},
				{
				...
				{
					search_terms: "Buccal Mucosa Squamous Cell Carcinoma",
					count: 6,
				},
				{
				...
				{
					search_terms: "Supraglottic Squamous Cell Carcinoma",
					count: 1,
				},
				{
					search_terms: "Hypopharyngeal Squamous Cell Carcinoma",
					count: 3,
				},
				{
					search_terms: "Lip and Oral Cavity Squamous Cell Carcinoma",
					count: 52,
				},
				{
				...
				{
					search_terms: "Floor of Mouth Squamous Cell Carcinoma",
					count: 6,
				},
				{
					search_terms: "Retromolar Trigone Squamous Cell Carcinoma",
					count: 4,
				},
			],
		},
		{
			search_terms: "Connective and Soft Tissue ",
			children: [
				{
				...
				{
					search_terms: "Childhood Gastrointestinal Stromal Tumor",
					count: 1,
				},
				{
				...
				{
					search_terms: "Undifferentiated Pleomorphic Sarcoma",
					count: 18,
				},
				{
				...
				{
					search_terms: "Uterine Corpus Myxoid Leiomyosarcoma",
					count: 1,
				},
				{
				...
				{
					search_terms: "Epithelioid Cell Type Gastrointestinal Stromal Tumor",
					count: 1,
				},
				{
				...
				{
					search_terms: "Mediastinal Sarcoma",
					count: 1,
				},
				{
				...
				{
					search_terms: "Soft Tissue Neoplasm",
					count: 5,
				},
				{
					search_terms: "Childhood Desmoplastic Small Round Cell Tumor",
					count: 5,
				},
				{
				...
				{
					search_terms: "Malignant Peripheral Nerve Sheath Tumor",
					count: 5,
				},
				{
				...
				{
					search_terms: "Soft Tissue Cancer",
					count: 2,
				},
				{
				...
				{
					search_terms: "Malignant Gastric Gastrointestinal Stromal Tumor",
					count: 2,
				},
				{
				...
				{
					search_terms: "Alveolar Soft Part Sarcoma",
					count: 2,
				},
				{
					search_terms: "Malignancy in Giant Cell Tumor of Bone",
					count: 3,
				},
				{
		...
		},
		{
			...
			children: [
				...
				{
					search_terms: "Thyroid Gland Hurthle Cell Carcinoma",
					count: 1,
				},
				{
					search_terms: "Lung Large Cell Neuroendocrine Carcinoma",
					count: 7,
				},
				{
					search_terms: "Hereditary Thyroid Gland Medullary Carcinoma",
					count: 1,
				},
				{
					search_terms: "Extrapulmonary Small Cell Neuroendocrine Carcinoma",
					count: 1,
				},
				{
				...
				{
					search_terms: "Cervical Small Cell Neuroendocrine Carcinoma",
					count: 2,
				},
				{
		...
		},
		{
			...
			children: [
				...
				{
					search_terms: "Glioblastoma, Not Otherwise Specified",
					count: 32,
				},
				{
				...
				{
					search_terms: "Meningioma",
					count: 1,
				},
				{
					search_terms: "Mixed Glioma",
					count: 1,
				},
				{
				...
				{
					search_terms: "Anaplastic Oligodendroglioma, Not Otherwise Specified",
					count: 3,
				},
				{
				...
				{
					search_terms: "Oligodendroglioma",
					count: 2,
				},
				{
		...
		},
		{
			...
			children: [
				...
				{
					search_terms: "Bladder Papillary Urothelial Carcinoma",
					count: 3,
				},
				{
		...
		},
		{
			...
			children: [
				...
				{
					search_terms: "Childhood Intraocular Retinoblastoma",
					count: 38,
				},
			],
		},
		{
			...
			children: [
				...
				{
					search_terms: "Invasive Breast Carcinoma of No Special Type",
					count: 158,
				},
				{
					search_terms: "Breast Adenocarcinoma with Spindle Cell Metaplasia",
					count: 1,
				},
				{
				...
				{
					search_terms: "Breast Micropapillary Ductal Carcinoma In Situ",
					count: 1,
				},
				{
				...
				{
					search_terms: "Breast Squamous Cell Carcinoma, Acantholytic Variant",
					count: 1,
				},
			],
		},
		{
			search_terms: "Peritoneal and Retroperitoneal ",
			children: [
				{
