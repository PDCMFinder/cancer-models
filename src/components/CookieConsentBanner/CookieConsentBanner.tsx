...
const CookieConsentBanner = () => {
	...
	// initially don't load Modal so there's no blink
	if (
		isClient &&
					...
					{!choosingCookies ? (
						<>
							<p className="text-center">
								...
								experience. For more information or to select your preferences,
								please click Choose Cookies.
							</p>
							...
							<DynamicAccordion className="bg-lightGray br-common p-2">
								<AccordionItem title="Strictly Necessary Cookies">
									<p>
										...
										request for services, such as setting your cookie
										preferences. You can set your browser to block or alert you
										about these cookies, but the site might not function as
										expected. These cookies do not store any personally
