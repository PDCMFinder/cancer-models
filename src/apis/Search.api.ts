...
export async function getSearchResults(
	...
	let response = await fetch(
		...
		}&select=provider_name,patient_age,patient_sex,external_model_id,model_type,data_source,histology,primary_site,collection_site,tumour_type,dataset_available,score&order=${sortBy}`,
